...
Example: If your have a pull request with changes in my_module3 and .travis.yml have this content:
    ...
    - VERSION="7.0" INCLUDE="my_module1,my_module2" INCLUDE_CHANGED="1"

Then you will have a test with next modules: my_module1, mymodule2 and *mymodule3*

If your have a pull request with changes in my_modules3 and .travis.yml have this content:

    - VERSION="7.0" INCLUDE_CHANGED="1"

Then you will have a test with next modules: *mymodule3*
